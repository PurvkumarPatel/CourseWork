...
int main()
{
    ...
    initwindow(screenWidth, screenHeight, "Sutherland Hodgeman polygon clipping algorithm");
    ...
    int numLines;
    cout << "Enter the number of lines polygon : ";
    cin >> numLines;
    
    int x1[numLines], y1[numLines], x2[numLines], y2[numLines];
    for (int i = 0; i < numLines; ++i)
    {
        cout << "Enter coordinates of line " << (i + 1) << " (x1 y1 x2 y2): ";
